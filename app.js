const translations = {
  zh: {
    ...
    loginCloudKicker: "登入",
    loginCloudTitle: "人生週曆",
    loginCloudIntro: "登入後建立自己的週曆，之後每一週都會同步保存。",
    loginProfileKicker: "首次設定",
    loginProfileTitle: "建立人生週曆",
    loginProfileIntro: "填寫名字、生日與預期壽命。已走過的週會先標成黑色，之後每格都能再修改。",
    loginSubmitCreate: "進入週曆",
    loginDemo: "使用示範資料",
    loginLocal: "未設定 Supabase 時，資料只存在此瀏覽器；設定後會用雲端帳號同步。",
    authTitle: "帳號",
    authIntro: "選擇登入方式。",
    authEmail: "Email",
    authPassword: "密碼",
  ...
  en: {
    ...
    loginCloudTitle: "Life Calendar",
    loginCloudIntro: "Sign in to create your calendar and keep every week in sync.",
    ...
    loginLocal: "Without Supabase config, data stays in this browser; once configured, cloud accounts sync the calendar.",
    authTitle: "Account",
